...
urlpatterns = [
    ...
    path('eliminar/<int:id>/', views.confirmar_eliminar_resumen, name='eliminar_resumen'),  # Vista de confirmación
    path('eliminar/<int:id>/confirmar/', views.eliminar_resumen, name='eliminar_resumen_confirmar'),  # Eliminación real
]